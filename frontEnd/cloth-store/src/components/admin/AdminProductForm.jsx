...
export default function AdminProductForm() {
  ...
  const fetchProduct = async () => {
    try {
      setIsLoading(true)
      const response = await axios.get(`https://cloth2-production.up.railway.app/api/products/${id}`, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = id ? `https://cloth2-production.up.railway.app/api/products/${id}` : "https://cloth2-production.up.railway.app/api/products"
