...
export default function AdminOrderList() {
  ...
  const updateOrderStatus = async (orderId, newStatus) => {
    try {
      await axios.patch(`https://cloth2-production.up.railway.app/api/orders/${orderId}`, 
        { status: newStatus },
        {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('adminToken')}`,
  ...
  const cancelOrder = async (orderId) => {
    try {
      await axios.post(`https://cloth2-production.up.railway.app/api/orders/${orderId}/cancel`, 
  ...
  const deleteOrder = async (orderId) => {
    setIsLoading(true)
    try {
      await axios.delete(`https://cloth2-production.up.railway.app/api/orders/delete-order/${orderId}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('adminToken')}`,
        },
      })
